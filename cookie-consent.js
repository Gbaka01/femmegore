/*!
 * Bandeau de consentement cookies — femmegore.fr (GOLI Gore Gbaka)
...
(function () {
  ...
  /* ========= CONFIGURATION ========= */
  var CONFIG = {
    siteName: "femmegore.fr",
    storageKey: "femmegore_consent",
    ...
    categories: [
      ...
      },
      {
        ...
        description: "Statistiques de fréquentation pour améliorer le site (Google Analytics et Google Tag Manager)."
      }
    ...
    wrap = el(
      '<div class="cc-wrap" role="dialog" aria-modal="false" aria-labelledby="cc-title" aria-describedby="cc-desc">' +
        '<div class="cc-box">' +
          ...
          '<p id="cc-desc">' + CONFIG.siteName + ' utilise des cookies de mesure d\'audience (Google Analytics) pour savoir quelles œuvres sont les plus vues. ' +
